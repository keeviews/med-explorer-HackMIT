...
export const COPY = {
  simple: {
    ...
    idleBody: "Try a button below. This is sample data for learning — not a prescription.",
    loading: "Searching…",
  ...
  detailed: {
    ...
    idleBody:
      "Results come from a small sample dataset for development, not clinical guidelines.",
    ...
    clear: "Clear",
    medicinesCount: (n: number) => `${n} medicine${n === 1 ? "" : "s"}`,
    sampleBadge: "Illustrative seed data",
    topic: "Topic",
